...
def _is_supported_xrootd_version(xrootd_client) -> bool:
...
try:
    _xrootd_client = import_module('XRootD.client')
    _xrootd_flags = import_module('XRootD.client.flags')
...
class Default(protocol.RSEProtocol):
    ...
    def _clear_unexpanded_x509_proxy(self):
